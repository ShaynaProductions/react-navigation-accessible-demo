        ...
        <>
            ...
            <List>
                <ListItem><strong>Base Components</strong> - <br/>
                    ...
                    Release: <Link
                        href="https://github.com/ShaynaProductions/react-navigation-accessible-demo/releases/tag/v0.1.0">Accessible
                ...
                <ListItem><strong>Base Structure</strong> - <br/>
                    ...
                    Release: <Link
                        href="https://github.com/ShaynaProductions/react-navigation-accessible-demo/releases/tag/v0.2.1">Implementing
